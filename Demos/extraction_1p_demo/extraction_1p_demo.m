...
extraction_options.min_corr=.4; %(Unrestricted initialization, set to .8 for Restricted initialization)
extraction_options.corr_noise=.0005;
extraction_options.merge_thr=[.7,.6,-1];
extraction_options.dmin=4; 
