...
%res_extract: (bool) indicates whether to extract neurons from residual
%outputs
...
%%
clear all
filename=fullfile('..','sample_2p_data','data_2p.mat'); %No ground truth available
...
figure()
imagesc(max(reshape(neuron.A,60,80,[]),[],3))