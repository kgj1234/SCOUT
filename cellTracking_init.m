function [correlation_matrices,distance_links,distance_metrics,...
    similarity_pref,weights,...
    neurons,links]=cellTracking_init(neurons,varargin)
...
defaults={{},[4,5,5,1,0,0],45,[],.5,.7,true,'align_to_base',{'affine','non-rigid'},'spatial',false,true,0,'Kmeans',ceil(length(neurons)/2),.5,false,20,.1,struct,false,1.5,true};
...
time=toc;
disp(['Initialiation: ', num2str(time), ' seconds'])