function [aligned_neurons,aligned_probabilities]=compute_cell_register(correlation_matrices,distance_links,...
    distance_metrics,similarity_pref,weights,method,max_dist,max_miss,min_prob,single_corr,corr_thresh,use_spatial,min_num_neighbors,chain_prob,binary_corr,max_sess_dist,centroids)
