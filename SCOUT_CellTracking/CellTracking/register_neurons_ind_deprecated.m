...
try
            ...
            if ~isequal(registration_method,'non-rigid')
                tform_a=imregtform(template,base_template,'translation',optimizer,metric);
                ...
                tform_b=imregtform(template,base_template,'affine',optimizer,metric);
                template=imwarp(template,tform_b,'OutputView',R);
