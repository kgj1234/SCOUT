function aligned_probabilities=construct_combined_probabilities(aligned_neurons,probabilities,pair_aligned,spat_aligned,dist_vals,min_prob,method,penalty,max_sess_dist)
