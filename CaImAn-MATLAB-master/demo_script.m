function neuron= demo_script(file,extraction_options)
% 2p recording extraction

%inputs

%file: filename of recording to be extracted (.mat or .avi extension) you
    %can also directly input the video (as a 4d matrix)
